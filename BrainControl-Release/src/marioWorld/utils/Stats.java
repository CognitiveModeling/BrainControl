...
public class Stats {
	...
	/**
	 * Converts a vector of Numbers into an array of double. This function does not necessarily belong here, but is commonly required in order to apply the
	 * statistical functions conveniently, since they only deal with arrays of double. (Note that a Number of the common superclass of all the Object versions
	 * of the primitives, such as Integer, Double etc.).
	 */
	...
	/**
	 * Returns the standard error of an array of double, where this is defined as the standard deviation of the sample divided by the square root of the sample
	 * size.
	 */
	...
	/**
	 * Returns a string that compares the root mean square of the data with the standard deviation of the data. This is probably too specialised to be of much
	 * general use.
	 */

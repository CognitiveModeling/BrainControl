...
public class BulbFlower extends Sprite {
	...
	public BulbFlower(LevelScene world, int x, int y) {
		kind = KIND_BULB_FLOWER;
		
		renderer = new SpriteRenderer(this, Art.items, 1, 0);
...
//	}
	...
	@Override
	public BulbFlower cloneWithNewLevelScene(LevelScene ls) {
		BulbFlower ret = (BulbFlower) super.clone();
		ret.runTime = runTime;

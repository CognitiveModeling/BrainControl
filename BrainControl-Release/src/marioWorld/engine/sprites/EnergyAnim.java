...
public class EnergyAnim extends Sprite {
	private int life = 16;

	public EnergyAnim(int xTile, int yTile) {
	...
	@Override
	public EnergyAnim cloneWithNewLevelScene(LevelScene ls) {
		EnergyAnim ret = (EnergyAnim) super.clone();
		ret.life = life;
		return ret;
	}
}

 ...
 ******************************************************************************/
/*
 * Modified by smihael to enable muting microphone
 * 
...
public class Microphone extends BaseDataProcessor {
	...
	public volatile boolean utteranceEndReached = true;
	...
	private TargetDataLine getAudioLine() {
		...
		try {
			...
			JOptionPane.showMessageDialog(PlayRelease.startGui, "Could not find any available audio line!\nPlease activate sound card or connect USB microphone!","Error occurred",JOptionPane.ERROR_MESSAGE);
	...
	class RecordingThread extends Thread {
		...
		private Data readData(Utterance utterance) throws IOException {
			...
			return (new DoubleData(samples, (int) audioStream.getFormat().getSampleRate(), collectTime,
					firstSampleNumber));
		}
	}
	...
	public boolean hasMoreData() {
		return !(utteranceEndReached && audioList.isEmpty()) && !stopRecognizing;
	}
}
